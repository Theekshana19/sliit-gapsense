...
public sealed class UpdateInterventionAssignmentRequestValidator : AbstractValidator<UpdateInterventionAssignmentRequest>
{
    ...
    public UpdateInterventionAssignmentRequestValidator()
    {
