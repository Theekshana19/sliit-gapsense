...
public sealed class CreateRecommendationRuleRequestValidator : AbstractValidator<CreateRecommendationRuleRequest>
{
    public CreateRecommendationRuleRequestValidator()
    {
